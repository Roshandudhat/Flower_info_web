...
var isLoginReq =localStorage.getItem("IsLogin");
var ontime = true;
// function getIsLogin(){
//     if(isLoginReq === "False"){
...
console.log(Emailid.value.match(mailformat));
  if (!Emailid.value) {
    $("#validEmailId").show();
...
// function getIsLogin(){
//   let getIsLogin = localStorage.getItem("old-users");
// }
